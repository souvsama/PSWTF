...
import com.guidewire.pstesting.claimcenter.claim.payment.CheckInstructionsScreen;
...
public class PersonalAutoClaimSettleAndCompleteTest extends ClaimCenterTestBase {
    ...
    public void TestSimpleClaimPayment(PersonalAutoClaimTestData claimData){
        ...
        ClaimPaymentWizardStepSet stepSet = financialSummaryScreen.createPayment();
        PayeeInformationScreen payeeInformationScreen = (PayeeInformationScreen) stepSet.getCurrentStepScreen();
        PaymentInformationScreen paymentInformationScreen = (PaymentInformationScreen) stepSet.clickNext();
        ...
        CheckInstructionsScreen checkInstructionsScreen = (CheckInstructionsScreen) stepSet.clickNext();
        FinancialPaymentsScreen financialPaymentsScreen = stepSet.clickFinish();
